...
const GeoLayout Geo_bitdw_1_0x2c5cd00[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom46496816_skybox_ptrlist, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bitdw_1_0xe084d40),
GEO_DISPLAY_LIST(5,DL_bitdw_1_0xe09c820),
GEO_DISPLAY_LIST(4,DL_bitdw_1_0xe0a3328),
GEO_RENDER_OBJ(),
