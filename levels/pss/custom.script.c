...
const LevelScript local_objects_pss_1_[] = {
	...
	OBJECT_WITH_ACTS(0, -851, -672, -6033, 0, 0, 0, 0x29101,  bhvWarp, 31),
	OBJECT_WITH_ACTS(0, -639, -672, -6222, 0, 0, 0, 0x29101,  bhvWarp, 31),
	OBJECT_WITH_ACTS(22, 1703, 129, -5262, 0, 0, 0, 0x30000,  bhvWarpPipe, 31),
	OBJECT_WITH_ACTS(0, -667, -672, -5935, 0, 0, 0, 0x29101,  bhvWarp, 31),
	OBJECT_WITH_ACTS(0, -925, -672, -5830, 0, 0, 0, 0x29101,  bhvWarp, 31),
	OBJECT_WITH_ACTS(0, -1062, -672, -6021, 0, 0, 0, 0x29101,  bhvWarp, 31),
	OBJECT_WITH_ACTS(0, -943, -672, -6281, 0, 0, 0, 0x29101,  bhvWarp, 31),
