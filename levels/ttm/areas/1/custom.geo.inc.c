...
const GeoLayout Geo_ttm_1_0x1eddf20[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom32210944_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_ttm_1_0xe0dc040),
					GEO_DISPLAY_LIST(4, DL_ttm_1_0xe0fe520),
					GEO_DISPLAY_LIST(5, DL_ttm_1_0xe102bf8),
					GEO_RENDER_OBJ(),
