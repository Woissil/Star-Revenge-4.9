...
const GeoLayout Geo_wdw_1_0x1d91380[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom30848096_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_wdw_1_0xe07a140),
					GEO_DISPLAY_LIST(4, DL_wdw_1_0xe08ca38),
					GEO_DISPLAY_LIST(5, DL_wdw_1_0xe08cb10),
					GEO_RENDER_OBJ(),
