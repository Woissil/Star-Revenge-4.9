...
const GeoLayout Geo_thi_1_0x2037490[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom33625456_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_thi_1_0xe0e4610),
					GEO_DISPLAY_LIST(4, DL_thi_1_0xe10cf28),
					GEO_DISPLAY_LIST(5, DL_thi_1_0xe112a88),
					GEO_RENDER_OBJ(),
