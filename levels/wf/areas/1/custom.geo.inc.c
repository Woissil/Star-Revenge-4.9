...
const GeoLayout Geo_wf_1_0x14f8b10[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom21826128_skybox_ptrlist, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_wf_1_0xe0e1120),
GEO_DISPLAY_LIST(4,DL_wf_1_0xe110e28),
GEO_DISPLAY_LIST(5,DL_wf_1_0xe113cc0),
GEO_RENDER_OBJ(),
