...
const GeoLayout Geo_sa_1_0x234dc10[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom36863216_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_sa_1_0xe0860b0),
					GEO_DISPLAY_LIST(4, DL_sa_1_0xe0a0ac0),
					GEO_DISPLAY_LIST(5, DL_sa_1_0xe0a2810),
					GEO_RENDER_OBJ(),
