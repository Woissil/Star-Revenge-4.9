...
const LevelScript local_objects_lll_1_[] = {
	...
	OBJECT_WITH_ACTS(0, -4562, 5775, 16437, 0, 46, 0, 0x280000,  bhvThiHugeIslandTop, 31),
	OBJECT_WITH_ACTS(0, -4201, 5498, 16111, 0, 1, 0, 0x50000,  bhvThiHugeIslandTop, 31),
	OBJECT_WITH_ACTS(0, -4210, 5112, 14220, 0, 1, 0, 0x1e0000,  bhvThiHugeIslandTop, 31),
	OBJECT_WITH_ACTS(0, -11614, 1278, 11390, 0, 314, 0, 0x460000,  bhvThiHugeIslandTop, 31),
	...
	OBJECT_WITH_ACTS(0, 1502, 2100, 14065, 0, 20, 0, 0x6e0000,  bhvThiHugeIslandTop, 31),
	...
	OBJECT_WITH_ACTS(0, -4, 4, 70, 0, 0, 20, 183,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -4, 4, 246, 0, 0, 20, 184,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -4, 4, 10, 0, 0, 20, 185,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -4, 4, 26, 0, 0, 20, 186,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -5, 4, 14, 0, 0, 20, 187,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -4, 4, 33, 0, 0, 20, 188,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -4, 4, 4, 0, 0, 20, 189,  RM_Scroll_Texture, 31),
	RETURN()
};
