...
const GeoLayout Geo_bowser_3_1_0x305dd70[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom50560592_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_bowser_3_1_0xe095640),
					GEO_DISPLAY_LIST(5, DL_bowser_3_1_0xe0b3c60),
					GEO_DISPLAY_LIST(4, DL_bowser_3_1_0xe0b4060),
					GEO_RENDER_OBJ(),
