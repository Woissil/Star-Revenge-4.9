...
const GeoLayout Geo_bowser_1_1_0x2f490c0[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom49426848_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_bowser_1_1_0xe04fc50),
					GEO_DISPLAY_LIST(4, DL_bowser_1_1_0xe061890),
					GEO_DISPLAY_LIST(5, DL_bowser_1_1_0xe0642f0),
					GEO_RENDER_OBJ(),
