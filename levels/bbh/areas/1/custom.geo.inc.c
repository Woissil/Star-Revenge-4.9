...
const GeoLayout Geo_bbh_1_0x1822c70[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom25139168_skybox_ptrlist, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bbh_1_0xe0bcad0),
GEO_DISPLAY_LIST(4,DL_bbh_1_0xe0d9b08),
GEO_DISPLAY_LIST(5,DL_bbh_1_0xe0dcdd0),
GEO_RENDER_OBJ(),
