...
const GeoLayout Geo_cotmc_2_0x2a8be70[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom44457808_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_cotmc_2_0xe0bded0),
					GEO_DISPLAY_LIST(5, DL_cotmc_2_0xe0e9a78),
					GEO_DISPLAY_LIST(4, DL_cotmc_2_0xe0f3a00),
					GEO_RENDER_OBJ(),
