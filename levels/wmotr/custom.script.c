...
const LevelScript local_objects_wmotr_2_[] = {
	...
	OBJECT_WITH_ACTS(0, -10, 4, 5, 0, 0, 20, 366,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -18, 4, 102, 0, 0, 20, 367,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -22, 4, 61, 0, 0, 20, 368,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -18, 4, 4, 0, 0, 20, 369,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -18, 4, 22, 0, 0, 20, 370,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -22, 4, 61, 0, 0, 20, 371,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -18, 4, 4, 0, 0, 20, 372,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -10, 4, 109, 0, 0, 20, 373,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -10, 4, 37, 0, 0, 20, 374,  RM_Scroll_Texture, 31),
	OBJECT_WITH_ACTS(0, -10, 4, 72, 0, 0, 20, 375,  RM_Scroll_Texture, 31),
	RETURN()
};
