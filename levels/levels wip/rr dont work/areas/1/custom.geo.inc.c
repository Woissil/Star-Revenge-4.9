...
const GeoLayout Geo_rr_1_0x226a3b0[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom35931280_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_rr_1_0xe07d1c0),
					GEO_DISPLAY_LIST(4, DL_rr_1_0xe096250),
					GEO_DISPLAY_LIST(5, DL_rr_1_0xe09a950),
					GEO_RENDER_OBJ(),
