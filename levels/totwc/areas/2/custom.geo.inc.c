...
const GeoLayout Geo_totwc_2_0x2b5a490[]= {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_NODE_ORTHO(100),
			GEO_OPEN_NODE(),
				GEO_BACKGROUND(SkyboxCustom45303424_skybox_ptrlist, geo_skybox_main),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(1, DL_totwc_2_0xe047680),
					GEO_DISPLAY_LIST(5, DL_totwc_2_0xe055d40),
					GEO_DISPLAY_LIST(4, DL_totwc_2_0xe0563c0),
					GEO_RENDER_OBJ(),
