...
const GeoLayout Geo_bob_1_0x13a7d20[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom20463552_skybox_ptrlist, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bob_1_0xe0c3890),
GEO_DISPLAY_LIST(4,DL_bob_1_0xe0eb4f8),
GEO_DISPLAY_LIST(5,DL_bob_1_0xe0ee700),
GEO_RENDER_OBJ(),
