...
const GeoLayout Geo_ccm_1_0x17034b0[]= {
...
GEO_NODE_ORTHO(100),
GEO_OPEN_NODE(),
GEO_BACKGROUND(SkyboxCustom23975312_skybox_ptrlist, geo_skybox_main),
GEO_CLOSE_NODE(),
GEO_CLOSE_NODE(),
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_ccm_1_0xe0b3300),
GEO_DISPLAY_LIST(4,DL_ccm_1_0xe0cd8f0),
GEO_DISPLAY_LIST(5,DL_ccm_1_0xe0db2e8),
GEO_RENDER_OBJ(),
