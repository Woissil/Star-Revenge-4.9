...
const GeoLayout Geo_bits_2_0x2da25b0[]= {
...
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bits_2_0xe09a940),
GEO_DISPLAY_LIST(5,DL_bits_2_0xe0b8ab8),
GEO_DISPLAY_LIST(4,DL_bits_2_0xe0ba1c0),
GEO_RENDER_OBJ(),
